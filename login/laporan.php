...
<?php 
  ...
  $uri = "laporan.php?tgla=$tgla&tglb=$tglb";
  $urx =  $_SERVER['REQUEST_URI'];
  $urx =  str_replace("laporan","claporan",$urx); 
  $urpdf =  str_replace("claporan","laporanpdf",$urx); 
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="page-header">
                            Reports <small><?php echo cetakDivisi($divisiuser); ?></small>
                        </h1>
...
<div class="col-sm-3">
             <label>Start Date:</label>
                 ...
                 <div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="Y-m-d">
                    <div class="form-inline">
                    <input id="txttgla" type="text" class="form-control" value="<?php echo $tgla;?>">
                           <span style="" class="input-group add-on"><i class="icon-th glyphicon glyphicon-calendar"  style="height:35px;"></i></span>      
...
<div class="col-sm-3">
             <label>End Date:</label>
                 ...
                 <div class="controls input-append date form_date" data-date-format="yyyy-mm-dd" data-link-field="dtp_input3" data-link-format="Y-m-d">
                    <div class="form-inline">
                    <input id="txttglb" type="text" class="form-control" value="<?php echo $tglb;?>">
                           <span style="" class="input-group add-on"><i class="icon-th glyphicon glyphicon-calendar" style="height:35px;"></i></span>      
                    ...
                    <div class="col-sm-2">
                          ...
                          <a class="btn btn-primary" onclick="caridata();">
                              <span class="glyphicon glyphicon-search"></span> Display Data
                          </a>
                    </div>
                    <div class="col-sm-2">
                          
                          <a class="btn btn-primary" href="<?php echo $urx; ?>">
                              <span class="glyphicon glyphicon-print"></span> Print Data
                          </a>
                    </div>
                     <div class="col-sm-2">
                          
                          <a class="btn btn-primary" href="<?php echo $urpdf; ?>">
                              <span class="glyphicon glyphicon-file"></span> Import Data PDF
                          </a>
                    </div>
...
<?php
  ...
  $tgla = mysql_result($laphas,$a,4); //ubah tanggal jadi hari/bulan
  ...
  $wktb   = "-";
  $tglb   = mysql_result($lapdet, 0, 3);
  $fkstatus = mysql_result($lapdet, 0, 2);
  $aminutes="-";
  if ($fkstatus == 3){$stat = "<a style='color:green;text-decoration:none;' href='$uri&swork=3'>Process</a>";$swork1=3;$staff  = mysql_result($lapnama, 0, 0);
        $idstaff  = mysql_result($lapnama, 0, 1); }
  if ($fkstatus == 4){$stat = "<a style='color:blue;text-decoration:none;' href='$uri&swork=4'>Done</a>"; $swork1=4;
  ...
  if ($fkstatus == ""){$stat = "<a style='color:red;text-decoration:none;' href='$uri&swork=0' >Waiting</a>";$swork1=0; }
...
?>
                                  ...
                                  <tr>
                                      ...
                                      <td data-title="Request Order"><a style="font-size:12px;" title="Tampilkan hanya tanggal <?php echo $tgla; ?>" href="laporan.php?tgla=<?php echo $tgla; ?>&tglb=<?php echo $tgla; ?>"><?php echo $tgla; ?></a></td>
                                      <td data-title="Request Order"><a title="Tampilkan hanya request <?php echo $namareq; ?>" href="<?php echo $uri; ?>&req=<?php echo $idnamareq; ?>"><?php echo $namareq; ?></a><br><small style="font-size:10px;"><p><?php echo $isireq; ?></p></small></td>
                                      <td data-title="Requestor"><a style="font-size:12px;" title="Tampilkan hanya request dari <?php echo $requestor; ?>" href="<?php echo $uri; ?>&nreq=<?php echo $idrequestor; ?>"><?php echo $requestor; ?></a></td>
                                      <td data-title="Unit Kerja"> <a style="font-size:12px;" title="Tampilkan hanya dari unit <?php echo $idnamaunit; ?>" href="laporan.php?unit=<?php echo $idnamaunit; ?>"><?php echo $namaunit; ?></td>
                                      <td data-title="Staff"><a style="font-size:12px;" href="<?php echo $uri; ?>&stf=<?php echo $idstaff; ?>"><?php echo $staff; ?></a></td>
                                      <td data-title="Start Work" style="font-size:12px;"><?php echo $tgla; ?> <?php echo $wkta; ?></td>
                                      <td data-title="Close Work" style="font-size:12px;"><?php echo $tglb; ?> <?php echo $wktb; ?></td>
                                      <td style="text-align:center" data-title="Work Time" style="font-size:12px;"><?php echo $aminutes; ?></td>
                                      <td data-title="Work Status" style="font-size:12px;"><?php echo $stat; ?></td>
                                  </tr>
