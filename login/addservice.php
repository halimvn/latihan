...
<body>
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                            Manage Service <small><?php echo cetakDivisi($divisiuser); ?></small>
                        </h1>
                        <!-- /.panel-heading -->
                        <button href="#"  data-toggle="modal" data-target="#mod291"  class="btn btn-primary" >Tambah</button>
       <br>
    ...
    <!-- Modal content-->
        ...
        <form action="actionservice.php" method="POST">
...
if (!empty($_POST["nama"] )){
            if(isset($_POST["nama"] ,$_POST["desc"],$_POST['cbostaff']) )                              
            {
                 $nama = $_POST["nama"];
                    $desc = $_POST["desc"];
                    $cbostaff = $_POST['cbostaff'];
                    $result = insertService($nama,$desc,$cbostaff);
            }
        }
        ...
        ?>
                                ...
                                <div class="row">
                                    ...
                                    <thead>
                                        <tr role="row"><th aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending" style="width: 207px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting_asc">No</th>
                                        <th aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending" style="width: 207px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting_asc">Nama</th>
                                        <th aria-label="Browser: activate to sort column ascending" style="width: 248px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Desc</th>
                                        <th aria-label="Browser: activate to sort column ascending" style="width: 248px;" colspan="1" rowspan="1" aria-controls="dataTables-example" tabindex="0" class="sorting">Biro</th>
                                    ...
                                    <tr role='row' class='gradeA odd'>
                                           ...
                                           <?php  echo $row['id'] ;?>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                             <a href="actiondeleteservice.php?nama=<?php echo $row['nama'];?>"> Delete </a>
                                            </td>
                                          </tr>
                                             </tbody>
                                      <?php 
